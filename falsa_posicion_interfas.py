...
class FalsaPosicionApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Método de Falsa Posición")
    ...
    def setup_ui(self):
        ...
        titulo = tk.Label(left_frame, text="Metodo de  la Regula Falsi", 
                         font=("Arial", 16, "bold"))
        ...
        try:
            ...
            while True:
                ...
                self.tabla.insert("", "end", values=(
                    n, f"{a:.4f}", f"{b:.4f}", f"{m:.4f}", f"{fm:.4f}", f"{error:.6f}"
                ))
